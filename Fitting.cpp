...
//function for matrix gauss elimination
void gaussEliminationLS(int m, int n, double a[3][4], double x[2]){
    int i,j,k;
    for(i=0;i<m-1;i++){
        //Partial Pivoting
        for(k=i+1;k<m;k++){
...
//func for printin matrix to console
void printMatrix(int m, int n, double matrix[3][4]){
    int i,j;
    for(i=0;i<m;i++){
        for(j=0;j<n;j++){
